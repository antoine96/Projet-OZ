	 ...
	 fun{ZombieCommand Command Count X Y MapListe R AntiBug L}
	    ...
	    if Count == 3 then
		  ...
		  elseif {CheckCase MapListe IX IY Floor}==true then
		     ...
		     {ZombieCommand Command Count+1 IX IY {UpdateList {UpdateList MapListe IX IY Zombie} X Y Floor} R 0 {UpdateListZombie L X Y IX IY}}
		  ...
		  elseif {CheckCase MapListe IX IY Medicine} orelse {CheckCase MapListe IX IY Bullets} orelse {CheckCase MapListe IX IY Food} then
			...
			{DrawBox Floor X Y}
			{NiceZombie DX DY IX IY}
			{ZombieCommand Command Count+2 IX IY {UpdateList {UpdateList MapListe IX IY Zombie} X Y Floor} R 0 {UpdateListZombie L X Y IX IY }}
		     else
			{ChooseDirection N}
			{ZombieCommand T Count X Y MapListe R AntiBug+1 L}
		     end
